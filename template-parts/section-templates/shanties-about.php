<?php
$tytul_1  = get_field('shanty_title-1');
$tresc_1  = get_field('shanty_content-1');
$tytul_2  = get_field('shanty_title-2');
$tresc_2  = get_field('shanty_content-2');
?>
...
<section class="shanties-about container">
    <div class="shanties-about__content">
        ...
        <?php if ( $tytul_1 ) : ?>
            <h2 class="shanties-about__title"><?= esc_html($tytul_1) ?></h2>
        <?php endif; ?>
        <?php if ( $tresc_1 ) : ?>
            <p class="shanties-about__text"><?= wp_kses_post($tresc_1) ?></p>
        <?php endif; ?>
    </div>
    ...
    <div class="shanties-about__content">
        ...
        <?php if ( $tytul_2 ) : ?>
            <h2 class="shanties-about__title"><?= esc_html($tytul_2) ?></h2>
        <?php endif; ?>
        <?php if ( $tresc_2 ) : ?>
            <p class="shanties-about__text"><?= wp_kses_post($tresc_2) ?></p>
        <?php endif; ?>
    </div>
